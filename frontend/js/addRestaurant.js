...
document.addEventListener('DOMContentLoaded', () => {
    document.getElementById('add-restaurant-btn')?.addEventListener('click', newRestaurant);
});
...
async function newRestaurant() {
    ...
    formData.append('restaurant[name]', nameInput.value.trim());
    formData.append('restaurant[vatNumber]', vatInput.value.trim());
    formData.append('restaurant[phone]', phoneInput.value.trim());
